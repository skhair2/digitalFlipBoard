            ...
            {isVisible && (
                <>
                    ...
                    <motion.button
                        ...
                        className="fixed top-4 right-4 md:top-6 md:right-6 z-[100] p-3 md:p-4 text-white bg-white/5 hover:bg-primary-500/20 border border-white/10 rounded-xl transition-all duration-200 group backdrop-blur-md shadow-lg"
                    ...
                    >
                        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-2 md:p-3 shadow-2xl shadow-black/50">
